...
const ResetPassword = () => {
  ...
  const inputRefs = React.useRef([]);
    ...
    // moving cursor to next input immediately on 
    const handleInput = (e, index)=>{
      ...
      // moving cursor to previous input on backspace
    ...
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400'>
      ...
      {!isOtpSubmitted && isEmailSent &&
        ...
        {isOtpSubmitted && isEmailSent && 
            ...
            <button className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3 cursor-pointerS'>Submit</button>
          </form>
        }
    </div>
  )
